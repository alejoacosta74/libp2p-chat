...
import (
	...
	// "github.com/alejoacosta74/libp2p-chat-app/p2p"
...
func InitMDNSdiscovery(ctx context.Context, n host.Host) error {
	...
	d := mdns.NewMdnsService(n, DiscoveryServiceTag, &discoveryNotifee{h: n, ctx: ctx})
	return d.Start()
}
...
func (d *discoveryNotifee) HandlePeerFound(pi peer.AddrInfo) {
	...
	logger.Info("discovered peer", "peer", pi.ID, "address", pi.Addrs)
